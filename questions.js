 ...
 * 修正說明：全面升級為雙反斜線轉義（\\\\），確保經由 DOM 寫入後，MathJax 能精準還原為單反斜線並完美渲染。
 */
const allQuestions = [
    {
        id: 1,
    ...
    },
    {
        ...
        mode1_steps: [
            ...
            { q: "步驟二：依據純電容之正交相位特性，判定其實際功因表現與虛功量值表現。", a: ["\\\\( \\\\text{因 } \\\\theta = -90^{\\\\circ}\\\\text{，故 } P = 0\\\\text{ W} \\\\ , \\\\ Q_C = VI\\\\sin(-90^{\\\\circ}) = -800\\\\text{ VAR} \\\\ , \\\\ S = 800\\\\\text{ VA} \\\\)", "\\\\( \\\\text{因 } \\\\theta = 0^{\\\\circ}\\\\text{，故 } P = 800\\\\text{ W} \\\\ , \\\\ Q_C = 0\\\\text{ VAR} \\\\ , \\\\ S = 800\\\\text{ VA} \\\\)"], correct: 0 },
